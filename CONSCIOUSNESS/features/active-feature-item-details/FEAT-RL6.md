...
## Acceptance Criteria
- [x] **AC-1** — First-visit and every-visit MC prediction implemented (evidence: TASK-RL048, commit 2116b3a — 3b_mc_practical.ipynb's mc_prediction() parameterized with first_visit: bool; both modes verified exact against 3a_mc_theory.ipynb's hand-worked S0→S1→S2→S1→S3 example)
