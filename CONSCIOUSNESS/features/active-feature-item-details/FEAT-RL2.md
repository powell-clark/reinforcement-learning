...
## Acceptance Criteria
- [ ] **AC-1** — Each algorithm lesson ships a from-scratch implementation of its core algorithm
- [ ] **AC-2** — Each algorithm lesson reproduces results with Stable-Baselines3 (or an equivalent framework)
- [ ] **AC-3** — From-scratch and framework results are compared on the same environment
- [ ] **AC-4** — API differences between the from-scratch and framework versions are documented
